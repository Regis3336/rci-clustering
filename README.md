...
2. Benchmark Comparison (comparsion_suite.py)
...
Output:
Generates results/scoreboard.csv (generated by comparsion_suite.py), produces the spectral-RCI visualization sphere_validation.png (generated by core.py), produces the homology-validation diagram cluster_evolution.png (generated by homology.py), saves both in the images/ folder, and computes all MEI scores.
